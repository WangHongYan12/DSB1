...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = E1B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(E1B_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = E3A_Pin|E3B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(E1A_GPIO_Port, E1A_Pin);

    HAL_GPIO_DeInit(E1B_GPIO_Port, E1B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, E3A_Pin|E3B_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, E4A_Pin|E4B_Pin);
